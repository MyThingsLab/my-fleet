...
[`reviews/`](reviews/) holds the periodic full-ecosystem reviews — read-only
assessments of what is actually running versus what is built, each scoring the
previous one's plan of action. Most recent: [2026-09](reviews/2026-09.md).
